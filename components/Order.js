...
export default function Order() {
  return (
    <section className="orderSection relative w-full z-20 pb-12 bg-glassback bg-cover bg-no-repeat ">
      <div className="overflow-hidden md:pt-12   mb-12 pb-12 max-w-[1440px] mx-auto">
        <div className="mx-auto  mt-12 pt-12">
          <div className="mx-auto w-full text-center">
          <h2 className="font-display leading-1 text-white md:text-9xl text-8xl uppercase pb-8">Coming soon</h2>
