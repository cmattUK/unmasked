        ...
        <div className='relative lg:pt-8 overflow-hidden lg:h-[600px] xl:h-screen'>
          <div className="bg-heroback bg-cover bg-center h-screen z-10 lg:py-auto lg:h-[600px] xl:h-screen">
            <div className="mx-auto lg:h-[600px]">
              <div className="mx-auto md:grid md:max-w-2xl md:grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2 bg-herobacksm bg-cover bg-left-bottom md:bg-none min-h-screen  xl:h-screen">
                  <Image src={portrait} className='w-full hidden md:block lg:pt-16 xl:pt-0 pt-0'  alt="A picture of Chris Matthewman"  priority/>
                <div className="lg:pt-4 flex h-full lg:h-[600px] xl:h-full justify-start items-center md:px-8 px-4">
                  <div className="absolute md:relative bottom-0 pb-8 md:pb-0 mb-8 z-30">
                    ...
                    <h2 className=" font-display leading-none text-[#dacf89] text-7xl lg:text-9xl xl:text-[17rem] uppercase pb-4 md:pb-0 drop-shadow-lg md:drop-shadow-none">Unmasked</h2>
